<?php
	...
	// Configuración de la página
 	define('SECCION', 'cursos-empresas-curso');
...
?>
	...
	<article>
			<section id="curso-detalle" class="empresas gris-2 banda">
				<div class="container">
					<div class="row">
						<a class="volver-listado" href="<?=url('cursos-empresas')?>">volver al listado <i class="fa fa-th" aria-hidden="true"></i></a>
					</div>
					<div class="row">
							...
							<div class="curso-detalle__left__promo">
								...
								<div class="curso-detalle__left__promo__text">
									<p><b>INSCRIBIÉNDOTE 5 DÍAS</b>
									   <br>antes del curso, tenés un precio promocional</p>
								</div>
							</div>
						</div>
