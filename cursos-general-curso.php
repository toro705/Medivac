<?php
	...
	// Configuración de la página
 	define('SECCION', 'cursos-general-curso');
...
?>
	...
	<article>
			<section id="curso-detalle" class="general gris-2 banda">
				<div class="container">
					<div class="row">
						<a class="volver-listado" href="<?=url('cursos-general')?>">volver al listado <i class="fa fa-th" aria-hidden="true"></i></a>
					</div>
					<div class="row">
